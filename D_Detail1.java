 ...
 */
public class D_Detail1 extends javax.swing.JFrame {

    /**
     * Creates new form D_Detail1
     */
    public D_Detail1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(113, 208, 80, 25);
        ...
        jScrollPane1.setBounds(10, 10, 470, 160);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String query = "select * from d_detail where D_Name like '"+jTextField1.getText()+"%' ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_Detail1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
