 ...
 */
public class D_Detail2 extends javax.swing.JFrame {

    /**
     * Creates new form D_Detail2
     */
    public D_Detail2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("By Group :");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(110, 190, 70, 25);

        jTextField1.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        getContentPane().add(jTextField1);
        jTextField1.setBounds(210, 190, 90, 25);
        ...
        jButton1.setBounds(210, 230, 90, 25);
        ...
        jButton2.setBounds(210, 270, 90, 25);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String query = "select * from d_detail where Blood_Group like '"+jTextField1.getText()+"%' ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_Detail2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
